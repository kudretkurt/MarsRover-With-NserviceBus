...
{
    public class ReceiverEndpointConfigurations
    {
        ...
        public static EndpointConfiguration GetDefaultEndpointConfiguration()
        {
            ...
            var endpointName =
                ApplicationConfiguration.Instance.GetValue<string>("MarsRoverContext:EndpointName");
            var errorQueueName =
                ApplicationConfiguration.Instance.GetValue<string>("MarsRoverContext:ErrorQueueName");
